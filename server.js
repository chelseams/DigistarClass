...
app.post('/users', verifyToken.isAdmin, (req, res) => {
    const user = req.body;
    query.createUser(user).then((data) => {
...
app.put('/users/:id', verifyToken.isAdmin, (req, res) => {
    ...
    const user = req.body;
    query.updateUser(id, user).then((data) => {
        res.status(200).send(data);
    }).catch((error) => {
        res.status(500).send(error);
    });
...
app.get('/users/search', verifyToken.isAdmin, (req, res) => {
    ...
    query.findUserByName(name).then((data) => {
        res.status(200).send(data);
    }).catch((error) => {
        res.status(500).send(error);
    });
...
app.post('/orders', verifyToken.isLogin, (req, res) => {
    ...
    query.createOrder(order).then((data) => {
        res.status(201).send(data);
    }).catch((error) => {
        res.status(500).send(error);
    });
...
app.put('/orders/:id', verifyToken.isAdmin, (req, res) => {
    ...
    query.updateOrder(id, order).then((data) => {
        res.status(200).send(data);
    }).catch((error) => {
        res.status(500).send(error);
    });
...
app.delete('/orders/:id', verifyToken.isAdmin, (req, res) => {
    ...
    query.deleteOrder(id).then((data) => {
        res.status(200).send(data);
    }).catch((error) => {
        res.status(500).send(error);
    });
...
app.get('/orders/search', verifyToken.isAdmin, (req, res) => {
    ...
    query.findOrderByName(product).then((data) => {
        res.status(200).send(data);
    }).catch((error) => {
        res.status(500).send(error);
    });
...
app.get('/orders/my', verifyToken.isLogin, (req, res) => {
    ...
    query.findMyOrder(id).then((data) => {
        res.status(200).send(data);
    }).catch((error) => {
        res.status(500).send(error);
    });
...
app.get('/orders/user/:user_id', verifyToken.isAdmin, (req, res) => {
    ...
    query.findOrderByUserId(user_id).then((data) => {
        res.status(200).send(data);
    }).catch((error) => {
        res.status(500).send(error);
    });
